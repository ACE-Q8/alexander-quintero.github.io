...
_.each = function(collection, func){
    ...
    if (Array.isArray(collection)){
        ...
        for (var i = 0; i < collection.length; i++){
            // pass current item in array, current index, and collection into func param
...
_.map = function(collection, func){
    // create out var and initialize as empty array
var output = [];
    // determine if collection is an array
    if (Array.isArray(collection)){
        // iterate through array
        for (let i = 0; i < collection.length; i++){
            // push result of invoking func on current value
            output.push(func(collection[i], i, collection));
        }

    } else { // else its an object
       for (let key in collection){// iterate through object
        // push the result
...
*   2) What if <function> is not given? // what if func was not passed a value
* Examples:
...
_.every = function(collection, func){
    ...
    if(!func){ // if func is undefined determine if array
            if (Array.isArray(collection)){
