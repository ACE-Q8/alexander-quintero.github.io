 ...
 */
/*
I: Function takes a if else if conditional and inputs a number to tell the time of day
O: Returns a gretting for the time of day that is inputed
C: Must return certain greeting for specific time of day
E: N/A
*/
